...
```
Frontend    → React, Next.js, TypeScript, Tailwind, shadcn/ui, Chrome Extensions
Backend     → Python, FastAPI, Node.js, PostgreSQL, pgvector, Redis
AI/GenAI    → RAG, Embeddings, LLM APIs (Groq/Gemini/OpenAI), Agentic Systems, LangChain
Infra       → Docker, GitLab CI/CD, GitHub Actions, Render, Neon.tech
AI Tools    → Claude Code, Cursor, GitHub Copilot, v0
```
...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-tenthinlay1-blue?style=flat&logo=linkedin)](https://linkedin.com/in/tenthinlay1)
[![Portfolio](https://img.shields.io/badge/Portfolio-tenzinthinlay.netlify.app-green?style=flat&logo=netlify)](https://tenzinthinlay.netlify.app/)
[![Email](https://img.shields.io/badge/Email-tenthinlayofficial@gmail.com-red?style=flat&logo=gmail)](mailto:tenthinlayofficial@gmail.com)

---

*Open to Full Stack, GenAI, or hybrid roles — remote preferred.*
